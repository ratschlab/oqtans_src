...
YY_BUFFER_STATE octave__scan_bytes (yyconst char *bytes,yy_size_t len  );
...
yy_size_t octave_get_leng (void );
 ...
 * @return the newly allocated buffer state object.
 */
YY_BUFFER_STATE octave__scan_bytes  (yyconst char * yybytes, yy_size_t  _yybytes_len )
{
	YY_BUFFER_STATE b;
	char *buf;
	yy_size_t n;
